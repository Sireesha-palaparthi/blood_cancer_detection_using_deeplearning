...
mydb = mysql.connector.connect(host='localhost', user='root', password='', port='3306', database='blood_cancer')
...
classes = ['Benign', 'Early', 'Pre', 'Pro']  # ← match your model's output order
